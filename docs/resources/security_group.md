...
- `egress_rule` (Block List) List of egress rules for the security group. Alternatively, you can use the thalassa_security_group_egress_rule resource for more flexibility. (see [below for nested schema](#nestedblock--egress_rule))
